...
type Filters = { from: string; to: string; vendor: string; category: string };
const empty: Filters = { from: "", to: "", vendor: "", category: "" };
...
const KEYS: (keyof Filters)[] = ["from", "to", "vendor", "category"];

export function useOverheadFilter() {
...
export function OverheadFilterPanel({
  isOpen,
  filters,
  setFilters,
  onApply,
